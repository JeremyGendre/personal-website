...
function App() {
    return (
        <>
            <Header/>
            <img src={process.env.PUBLIC_URL + '/images/welcome2.png'}/>
            <img src={process.env.PUBLIC_URL + '/images/fond_info.jpg'}/>

            <div id="content">
                <div id="profile" className="content-articles">
                    <h1 className="titles"><i className="fas fa-user-circle icons-left"></i>PROFIL</h1>
                    <div className="row">
                        <div id="profile-content-text" className="col-sm-8">
