...
export default function ProjectTag(props: ProjectTagType) {
    return (
        <div className="flex justify-center text-center mr-2 border-white border-1 rounded-full px-2 hover:bg-gray-100 hover:bg-opacity-20 transition duration-150">
